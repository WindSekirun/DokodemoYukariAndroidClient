...
class ObservableStringObservable(private val observableString: ObservableString) : Observable<String>() {
...
fun ObservableString.propertyChanges() = ObservableStringObservable(this)